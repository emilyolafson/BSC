...
function [pval_500] = pvalvsNull(readleft1,readright1,readleft2,readright2,permno,wsname)
load(wsname)
...
pval_500=length(find(nullrho>realrho))/permno;

dlmwrite('/Users/emilyolafson/Documents/BSC/spin-test/m_f/nullrho_betas.txt', nullrho)
dlmwrite( '/Users/emilyolafson/Documents/BSC/spin-test/m_f/realrho_betas.txt', realrho)
