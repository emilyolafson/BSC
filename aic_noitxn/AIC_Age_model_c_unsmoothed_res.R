...
#left
model1_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX + Sex_edit +as.numeric(FIQ), TO)
vertexFDR(model1_TO_L)
model2_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age +as.numeric(FIQ) + Sex_edit , TO)
vertexFDR(model2_TO_L)
model3_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age +as.numeric(FIQ) + Sex_edit , TO)
...
#####
#right
model1_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ)+ Sex_edit, TO)
vertexFDR(model1_TO_R)
model2_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, TO)
vertexFDR(model2_TO_R)
model3_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, TO)
...
model1_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, KKI)
vertexFDR(model1_KKI_L)
model2_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, KKI)
vertexFDR(model2_KKI_L)
model3_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, KKI)
...
model1_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX+ as.numeric(FIQ)+ Sex_edit, KKI)
vertexFDR(model1_KKI_R)
model2_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, KKI)
vertexFDR(model2_KKI_R)
model3_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, KKI)
vertexFDR(model2_KKI_R)
...
##write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_KKI_R_AIC.csv", sep=",", row.names=F)
...
model1_NYU_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, NYU)
vertexFDR(model1_NYU_L)
model2_NYU_L <- vertexLm(model_c_unsmoothed_left ~DX*Age + as.numeric(FIQ)+ Sex_edit, NYU)
vertexFDR(model2_NYU_L)
model3_NYU_L <- vertexLm(model_c_unsmoothed_left ~DX+Age + as.numeric(FIQ)+ Sex_edit, NYU)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_NYU_L_AIC.csv", sep=",", row.names=F)
...
model1_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX+ as.numeric(FIQ)+ Sex_edit, NYU)
vertexFDR(model1_NYU_R)
model2_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, NYU)
vertexFDR(model2_NYU_R)
model3_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, NYU)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_NYU_R_AIC.csv", sep=",", row.names=F)
...
model1_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+ as.numeric(FIQ)+ Sex_edit, OHSU)
vertexFDR(model1_OHSU_L)
model2_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, OHSU)
vertexFDR(model2_OHSU_L)
model3_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, OHSU)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_OHSU_L_AIC.csv", sep=",", row.names=F)
whichbest_OHSU_L<-as.data.frame(whichbest_OHSU_L)
table(whichbest_OHSU_L)
 
#####
model1_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+ as.numeric(FIQ)+ Sex_edit, OHSU)
vertexFDR(model1_OHSU_R)
model2_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, OHSU)
vertexFDR(model2_OHSU_R)
model3_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, OHSU)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_OHSU_R_AIC.csv", sep=",", row.names=F)
...
model1_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+ as.numeric(FIQ)+ Sex_edit, SDSU)
vertexFDR(model1_SDSU_L)
model2_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, SDSU)
vertexFDR(model2_SDSU_L)
model3_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, SDSU)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_SDSU_L_AIC.csv", sep=",", row.names=F)
whichbest_SDSU_L<-as.data.frame(whichbest_SDSU_L)
table(whichbest_SDSU_L)

#####
model1_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ)+ Sex_edit, SDSU)
vertexFDR(model1_SDSU_R)
model2_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, SDSU)
vertexFDR(model2_SDSU_R)
model3_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, SDSU)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_SDSU_R_AIC.csv", sep=",", row.names=F)
...
model1_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX+ as.numeric(FIQ)+ Sex_edit, UM)
vertexFDR(model1_UM_L)
model2_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, UM)
vertexFDR(model2_UM_L)
model3_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, UM)
vertexFDR(model3_UM_L)
AICc_UM_left<-compare_models(model1_UM_L, model2_UM_L,model2_UM_L,metric = AICc)
#AIC: which model is best at each vertex (which AIC is lowest) :
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_UM_L_AIC.csv", sep=",", row.names=F)
whichbest_UM_L<-as.data.frame(whichbest_UM_L)
table(whichbest_UM_L)

#####
model1_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ)+ Sex_edit, UM)
vertexFDR(model1_UM_R)
model2_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, UM)
vertexFDR(model2_UM_R)
model3_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, UM)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_UM_R_AIC.csv", sep=",", row.names=F)
...
model1_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, IP)
vertexFDR(model1_IP_L)
model2_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, IP)
vertexFDR(model2_IP_L)
model3_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, IP)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_IP_L_AIC.csv", sep=",", row.names=F)
whichbest_IP_L<-as.data.frame(whichbest_IP_L)
table(whichbest_IP_L)

#####
model1_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ)+ Sex_edit, IP)
vertexFDR(model1_IP_R)
model2_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, IP)
vertexFDR(model2_IP_R)
model3_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, IP)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_IP_R_AIC.csv", sep=",", row.names=F)
...
model1_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, IoP)
vertexFDR(model1_IoP_L)
model2_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, IoP)
vertexFDR(model2_IoP_L)
model3_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, IoP)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_IoP_L_AIC.csv", sep=",", row.names=F)
whichbest_IoP_L<-as.data.frame(whichbest_IoP_L)
table(whichbest_IoP_L)

#####
model1_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ)+ Sex_edit, IoP)
vertexFDR(model1_IoP_R)
model2_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, IoP)
vertexFDR(model2_IoP_R)
model3_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, IoP)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_IoP_R_AIC.csv", sep=",", row.names=F)
...
model1_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, CAM)
vertexFDR(model1_CAM_L)
model2_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, CAM)
vertexFDR(model2_CAM_L)
model3_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, CAM)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_CAM_L_AIC.csv", sep=",", row.names=F)
whichbest_CAM_L<-as.data.frame(whichbest_CAM_L)
table(whichbest_CAM_L)

#####
model1_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX+ as.numeric(FIQ)+ Sex_edit, CAM)
vertexFDR(model1_CAM_R)
model2_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, CAM)
vertexFDR(model2_CAM_R)
model3_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, CAM)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_CAM_R_AIC.csv", sep=",", row.names=F)
whichbest_CAM_R<-as.data.frame(whichbest_CAM_R)
table(whichbest_CAM_R)

#CAMBRIDGE
model1_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, CAMBRIDGE)
vertexFDR(model1_CAMBRIDGE_L)
model2_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
vertexFDR(model2_CAMBRIDGE_L)
model3_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/whichbest_CAMBRIDGE_L_AIC.csv", sep=",", row.names=F)
whichbest_CAMBRIDGE_L<-as.data.frame(whichbest_CAMBRIDGE_L)
table(whichbest_CAMBRIDGE_L)

#####
model1_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX+ as.numeric(FIQ)+ Sex_edit, CAMBRIDGE)
vertexFDR(model1_CAMBRIDGE_R)
model2_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
vertexFDR(model2_CAMBRIDGE_R)
model3_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/revisions/whichbest_CAMBRIDGE_R_AIC.csv", sep=",", row.names=F)
...
#MAX_MUN
model1_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ)+ Sex_edit, MAX_MUN)
vertexFDR(model1_MAX_MUN_L)
model2_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age + as.numeric(FIQ) + Sex_edit, MAX_MUN)
vertexFDR(model2_MAX_MUN_L)
model3_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age + as.numeric(FIQ) + Sex_edit, MAX_MUN)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/revisions/whichbest_MAX_MUN_L_AIC.csv", sep=",", row.names=F)
whichbest_MAX_MUN_L<-as.data.frame(whichbest_MAX_MUN_L)
table(whichbest_MAX_MUN_L)

#####
model1_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ)+ Sex_edit, MAX_MUN)
vertexFDR(model1_MAX_MUN_R)
model2_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age + as.numeric(FIQ) + Sex_edit, MAX_MUN)
vertexFDR(model2_MAX_MUN_R)
model3_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age + as.numeric(FIQ) + Sex_edit, MAX_MUN)
...
#write.table(whichbest, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/revisions/whichbest_MAX_MUN_R_AIC.csv", sep=",", row.names=F)
...
write.table(whichbest_L_combined, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/AIC_age/age_whichbest_L_combined_model_c.csv", sep=",", row.names=F)
write.table(whichbest_R_combined, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/AIC_age/age_whichbest_R_combined_model_c.csv", sep=",", row.names=F)
