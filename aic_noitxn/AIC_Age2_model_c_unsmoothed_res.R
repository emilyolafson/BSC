...
model2_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 +as.numeric(FIQ) + Sex_edit , TO)
vertexFDR(model2_TO_L)
model3_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age_2 +as.numeric(FIQ) + Sex_edit , TO)
...
model2_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, TO)
vertexFDR(model2_TO_R)
model3_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, TO)
...
model2_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, KKI)
vertexFDR(model2_KKI_L)
model3_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, KKI)
...
model2_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, KKI)
vertexFDR(model2_KKI_R)
model3_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, KKI)
vertexFDR(model2_KKI_R)
...
model2_NYU_L <- vertexLm(model_c_unsmoothed_left ~DX*Age_2 + as.numeric(FIQ)+ Sex_edit, NYU)
vertexFDR(model2_NYU_L)
model3_NYU_L <- vertexLm(model_c_unsmoothed_left ~DX+Age_2 + as.numeric(FIQ)+ Sex_edit, NYU)
...
model2_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, NYU)
vertexFDR(model2_NYU_R)
model3_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, NYU)
...
model2_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, OHSU)
vertexFDR(model2_OHSU_L)
model3_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, OHSU)
...
model2_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, OHSU)
vertexFDR(model2_OHSU_R)
model3_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, OHSU)
...
model2_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, SDSU)
vertexFDR(model2_SDSU_L)
model3_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, SDSU)
...
model2_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, SDSU)
vertexFDR(model2_SDSU_R)
model3_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, SDSU)
...
model2_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, UM)
vertexFDR(model2_UM_L)
model3_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, UM)
...
model2_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, UM)
vertexFDR(model2_UM_R)
model3_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, UM)
...
model2_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, IP)
vertexFDR(model2_IP_L)
model3_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, IP)
...
model2_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, IP)
vertexFDR(model2_IP_R)
model3_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, IP)
...
model2_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, IoP)
vertexFDR(model2_IoP_L)
model3_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, IoP)
...
model2_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, IoP)
vertexFDR(model2_IoP_R)
model3_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, IoP)
...
model2_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, CAM)
vertexFDR(model2_CAM_L)
model3_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, CAM)
...
model2_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, CAM)
vertexFDR(model2_CAM_R)
model3_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, CAM)
...
model2_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
vertexFDR(model2_CAMBRIDGE_L)
model3_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
...
model2_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
vertexFDR(model2_CAMBRIDGE_R)
model3_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, CAMBRIDGE)
...
model2_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, MAX_MUN)
vertexFDR(model2_MAX_MUN_L)
model3_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, MAX_MUN)
...
model2_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX*Age_2 + as.numeric(FIQ) + Sex_edit, MAX_MUN)
vertexFDR(model2_MAX_MUN_R)
model3_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX+Age_2 + as.numeric(FIQ) + Sex_edit, MAX_MUN)
...
write.table(whichbest_L_combined, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/AIC_age2/age2_whichbest_L_combined_model_c.csv", sep=",", row.names=F)
write.table(whichbest_R_combined, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/AIC_age2/age2_whichbest_R_combined_model_c.csv", sep=",", row.names=F)
