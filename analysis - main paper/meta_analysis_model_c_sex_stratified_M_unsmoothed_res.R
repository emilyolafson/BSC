...
for (i in 1: length(unique(gf$Site_combined))){
  ...
  data =subset(data, Sex_edit=="Male")
  if (dim(data)[1] == 0){
    next()
  }
  N= nrow(data)
...
write.table(meta_analysis_model_c_unsmoothed_left_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_left_beta_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_right_beta_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
write.table(meta_analysis_model_c_unsmoothed_left_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_left_p_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_right_p_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)

write.csv(meta_analysis_model_c_unsmoothed_left_1,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_left.csv", row.names = FALSE)
write.csv(meta_analysis_model_c_unsmoothed_right_1,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_right.csv", row.names = FALSE)
...
#write out masked, FDR-adjusted p-values for visualization.
write.table(meta_analysis_model_c_unsmoothed_left_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_left_p_adjust_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_M_DX_right_p_adjust_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)


###Write out vertstats files for visualization
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_left_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_left_unsmoothed_sex_stratified_M_DX.vertstats", headers=TRUE)
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_right_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_right_unsmoothed_sex_stratified_M_DX.vertstats", headers=TRUE)


save.image(file = "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/meta_analysis_sex_stratified_M_DX_model_c.RData")
