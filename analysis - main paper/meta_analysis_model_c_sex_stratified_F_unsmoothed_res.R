...
setwd("/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/")
write.table(gf, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/Final_gf.csv")
...
for (i in 1: length(unique(gf$Site_combined))){
  ...
  data =subset(data, Sex_edit=="Female")
  if (dim(data)[1] == 0){
    next()
  }
  N= nrow(data)
  ...
  site_results <- vertexLm(data$model_c_unsmoothed_left~ DX + Age + as.numeric(FIQ), data = data)
...
for (i in 1: length(unique(gf$Site_combined))){
  ...
  #Statistical model to be used here. Uses mni.vertex.statistics from mni.cortical.statistics package
  site_results <- vertexLm(data$model_c_unsmoothed_right~ DX + Age + as.numeric(FIQ), data = data)
  #degrees of freedom does not get included if you immediately turn site_results into a dataframe. must extract it first.
  df <- attr(site_results, 'df')[[2]][1]
  #turn into a df to append data
  site_results <- as.data.frame(site_results)
...
meta_analysis_model_c_unsmoothed_left_1 <- as.data.frame(meta_analysis_model_c_unsmoothed_left)
...
write.table(meta_analysis_model_c_unsmoothed_left_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_left_beta_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_right_beta_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
write.table(meta_analysis_model_c_unsmoothed_left_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_left_p_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_right_p_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
#write out masked, FDR-adjusted p-values for visualization.
write.table(meta_analysis_model_c_unsmoothed_left_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_left_p_adjust_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_right_p_adjust_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)

write.csv(meta_analysis_model_c_unsmoothed_left_1,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_left.csv", row.names = FALSE)
write.csv(meta_analysis_model_c_unsmoothed_right_1,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_unsmoothed_sex_stratified_F_DX_right.csv", row.names = FALSE)

###Write out vertstats files for visualization
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_left_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_left_unsmoothed_sex_stratified_F_DX.vertstats", headers=TRUE)
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_right_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/model_c_right_unsmoothed_sex_stratified_F_DX.vertstats", headers=TRUE)


save.image(file = "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/sex_stratified/unsmoothed/residualized/meta_analysis_sex_stratified_F_DX_model_c.RData")
