...
write.table(gf, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/age_stratified/Final_gf.csv")
...
write.table(meta_analysis_model_c_unsmoothed_left_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_unsmoothed_age_stratified_under18_DX_left_beta_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_unsmoothed_age_stratified_under18_DX_right_beta_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
write.table(meta_analysis_model_c_unsmoothed_left_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_unsmoothed_age_stratified_under18_DX_left_p_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_unsmoothed_age_stratified_under18_DX_right_p_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
#write out masked, FDR-adjusted p-values for visualization.
write.table(meta_analysis_model_c_unsmoothed_left_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_unsmoothed_age_stratified_under18_DX_left_p_adjust_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_unsmoothed_age_stratified_under18_DX_right_p_adjust_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)


###Write out vertstats files for visualization
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_left_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_left_unsmoothed_age_stratified_under18_DX.vertstats", headers=TRUE)
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_right_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/model_c_right_unsmoothed_age_stratified_under18_DX.vertstats", headers=TRUE)


save.image(file = "/data/chamal/projects/emilyO/Tissue_contrast/analysis/age_stratified/meta_analysis_age_stratified_under18_DX_model_c.RData")
