...
#left
model1_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age+ Sex_edit, TO)
vertexFDR(model1_TO_L)
model2_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, TO)
vertexFDR(model2_TO_L)
model3_TO_L <- vertexLm(model_c_unsmoothed_left ~ DX+as.numeric(FIQ) + Age+ Sex_edit, TO)
...
#####
#right
model1_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age+ Sex_edit, TO)
vertexFDR(model1_TO_R)
model2_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, TO)
vertexFDR(model2_TO_R)
model3_TO_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, TO)
vertexFDR(model3_TO_R)
AICc_TO_right<-compare_models(model1_TO_R, model2_TO_R, model2_TO_R, metric = AICc)
...
model1_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, KKI)
vertexFDR(model1_KKI_L)
model2_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, KKI)
vertexFDR(model2_KKI_L)
model3_KKI_L <- vertexLm(model_c_unsmoothed_left ~ DX+as.numeric(FIQ) + Age+ Sex_edit, KKI)
...
model1_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, KKI)
vertexFDR(model1_KKI_R)
model2_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, KKI)
vertexFDR(model2_KKI_R)
model3_KKI_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, KKI)
...
model1_NYU_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, NYU)
vertexFDR(model1_NYU_L)
model2_NYU_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, NYU)
vertexFDR(model2_NYU_L)
model3_NYU_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ) + Age+ Sex_edit, NYU)
...
model1_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, NYU)
vertexFDR(model1_NYU_R)
model2_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, NYU)
vertexFDR(model2_NYU_R)
model3_NYU_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, NYU)
...
model1_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, OHSU)
vertexFDR(model1_OHSU_L)
model2_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, OHSU)
vertexFDR(model2_OHSU_L)
model3_OHSU_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ) + Age+ Sex_edit, OHSU)
...
#####
model1_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, OHSU)
vertexFDR(model1_OHSU_R)
model2_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, OHSU)
vertexFDR(model2_OHSU_R)
model3_OHSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, OHSU)
...
model1_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, SDSU)
vertexFDR(model1_SDSU_L)
model2_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, SDSU)
vertexFDR(model2_SDSU_L)
model3_SDSU_L <- vertexLm(model_c_unsmoothed_left ~ DX+as.numeric(FIQ) + Age+ Sex_edit, SDSU)
...
#####
model1_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, SDSU)
vertexFDR(model1_SDSU_R)
model2_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, SDSU)
vertexFDR(model2_SDSU_R)
model3_SDSU_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, SDSU)
...
model1_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, UM)
vertexFDR(model1_UM_L)
model2_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, UM)
vertexFDR(model2_UM_L)
model3_UM_L <- vertexLm(model_c_unsmoothed_left ~ DX+as.numeric(FIQ) + Age+ Sex_edit, UM)
...
#####
model1_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, UM)
vertexFDR(model1_UM_R)
model2_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, UM)
vertexFDR(model2_UM_R)
model3_UM_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, UM)
...
model1_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, IP)
vertexFDR(model1_IP_L)
model2_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, IP)
vertexFDR(model2_IP_L)
model3_IP_L <- vertexLm(model_c_unsmoothed_left ~ DX+as.numeric(FIQ) + Age+ Sex_edit, IP)
...
#####
model1_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, IP)
vertexFDR(model1_IP_R)
model2_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, IP)
vertexFDR(model2_IP_R)
model3_IP_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ) + Age+ Sex_edit, IP)
...
model1_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, IoP)
vertexFDR(model1_IoP_L)
model2_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, IoP)
vertexFDR(model2_IoP_L)
model3_IoP_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ) + Age+ Sex_edit, IoP)
...
#####
model1_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, IoP)
vertexFDR(model1_IoP_R)
model2_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, IoP)
vertexFDR(model2_IoP_R)
model3_IoP_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, IoP)
...
model1_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, CAM)
vertexFDR(model1_CAM_L)
model2_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, CAM)
vertexFDR(model2_CAM_L)
model3_CAM_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ) + Age+ Sex_edit, CAM)
...
#####
model1_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, CAM)
vertexFDR(model1_CAM_R)
model2_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, CAM)
vertexFDR(model2_CAM_R)
model3_CAM_R <- vertexLm(model_c_unsmoothed_right ~ DX + as.numeric(FIQ) + Age+ Sex_edit, CAM)
...
#CAMBRIDGE
model1_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, CAMBRIDGE)
vertexFDR(model1_CAMBRIDGE_L)
model2_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, CAMBRIDGE)
vertexFDR(model2_CAMBRIDGE_L)
model3_CAMBRIDGE_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ) + Age+ Sex_edit, CAMBRIDGE)
...
#####
model1_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, CAMBRIDGE)
vertexFDR(model1_CAMBRIDGE_R)
model2_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, CAMBRIDGE)
vertexFDR(model2_CAMBRIDGE_R)
model3_CAMBRIDGE_R <- vertexLm(model_c_unsmoothed_right ~ DX+as.numeric(FIQ) + Age+ Sex_edit, CAMBRIDGE)
...
#MAX_MUN
model1_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX + Age + Sex_edit, MAX_MUN)
vertexFDR(model1_MAX_MUN_L)
model2_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX*as.numeric(FIQ) + Age+ Sex_edit, MAX_MUN)
vertexFDR(model2_MAX_MUN_L)
model3_MAX_MUN_L <- vertexLm(model_c_unsmoothed_left ~ DX + as.numeric(FIQ) + Age+ Sex_edit, MAX_MUN)
...
#####
model1_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX + Age + Sex_edit, MAX_MUN)
vertexFDR(model1_MAX_MUN_R)
model2_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX*as.numeric(FIQ) + Age+ Sex_edit, MAX_MUN)
vertexFDR(model2_MAX_MUN_R)
model3_MAX_MUN_R <- vertexLm(model_c_unsmoothed_right ~ DX+ as.numeric(FIQ) + Age+ Sex_edit, MAX_MUN)
...
write.table(whichbest_L_combined, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/AIC_FIQ/FIQ_whichbest_L_combined_model_c.csv", sep=",", row.names=F)
write.table(whichbest_R_combined, file="/data/chamal/projects/emilyO/Tissue_contrast/analysis/revisions/AIC_FIQ/FIQ_whichbest_R_combined_model_c.csv", sep=",", row.names=F)
