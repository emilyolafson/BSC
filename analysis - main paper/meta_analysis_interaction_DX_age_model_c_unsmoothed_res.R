...
setwd("/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/")
write.table(gf, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/Final_gf.csv")
...
write.table(meta_analysis_model_c_unsmoothed_left_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_age_left_beta_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_age_right_beta_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
write.table(meta_analysis_model_c_unsmoothed_left_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_age_left_p_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_age_right_p_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
#write out masked, FDR-adjusted p-values for visualization.
write.table(meta_analysis_model_c_unsmoothed_left_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_age_left_p_adjust_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_age_right_p_adjust_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)


###Write out vertstats files for visualization
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_left_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_left_unsmoothed_interaction_DX_age.vertstats", headers=TRUE)
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_right_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/model_c_right_unsmoothed_interaction_DX_age.vertstats", headers=TRUE)


save.image(file = "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_age_interaction/unsmoothed/residualized/meta_analysis_interaction_DX_age_model_c.RData")
