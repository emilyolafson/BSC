...
setwd("/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/")
write.table(gf, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/Final_gf.csv")
...
for (i in 1: length(unique(gf$Site_combined))){
  ...
  site_results <- vertexLm(data$model_c_unsmoothed_left~ DX*Sex_edit + Age + as.numeric(FIQ), data = data)
  ...
  site_results$Cohens_d <- { site_results$'tvalue-DXASD:Sex_editFemale'  * (N1 + N2) } / { sqrt(N1 * N2) * sqrt(site_results$df) }
...
for (i in 1: length(unique(gf$Site_combined))){
  ...
  #Statistical model to be used here. Uses mni.vertex.statistics from mni.cortical.statistics package
  site_results <- vertexLm(data$model_c_unsmoothed_right~ DX*Sex_edit + Age + as.numeric(FIQ), data = data)
  #degrees of freedom does not get included if you immediately turn site_results into a dataframe. must extract it first.
  df <- attr(site_results, 'df')[[2]][1]
  #turn into a df to append data
  site_results <- as.data.frame(site_results)
...
write.table(meta_analysis_model_c_unsmoothed_left_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_sex_left_beta_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_sex_right_beta_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
write.table(meta_analysis_model_c_unsmoothed_left_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_sex_left_p_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_sex_right_p_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
#write out masked, FDR-adjusted p-values for visualization.
write.table(meta_analysis_model_c_unsmoothed_left_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_sex_left_p_adjust_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_unsmoothed_interaction_DX_sex_right_p_adjust_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)


###Write out vertstats files for visualization
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_left_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_left_unsmoothed_interaction_DX_sex.vertstats", headers=TRUE)
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_right_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/model_c_right_unsmoothed_interaction_DX_sex.vertstats", headers=TRUE)


save.image(file = "/data/chamal/projects/emilyO/Tissue_contrast/analysis/cortical_gradient/meta-analysis/DX_sex_interaction/unsmoothed/residualized/meta_analysis_interaction_DX_sex_model_c.RData")
