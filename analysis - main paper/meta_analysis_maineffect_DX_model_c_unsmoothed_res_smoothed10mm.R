...
setwd("/data/chamal/projects/emilyO/Tissue_contrast/derivatives/final_pipeline_outputs/residualized/model_c_10mm/")
...
gf$model_c_unsmoothed_left <- paste("/data/chamal/projects/emilyO/Tissue_contrast/derivatives/final_pipeline_outputs/residualized/model_c_10mm/",gf$Subject_ID ,"_model_c_resid_left_10mm.txt", sep ="")
gf$model_c_unsmoothed_right <- paste("/data/chamal/projects/emilyO/Tissue_contrast/derivatives/final_pipeline_outputs/residualized/model_c_10mm/",gf$Subject_ID , "_model_c_resid_right_10mm.txt", sep ="")
...
write.table(meta_analysis_model_c_unsmoothed_left_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_unsmoothed_maineffect_DX_left_beta_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_beta_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_unsmoothed_maineffect_DX_right_beta_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
write.table(meta_analysis_model_c_unsmoothed_left_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_unsmoothed_maineffect_DX_left_p_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_unsmoothed_maineffect_DX_right_p_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)
...
#write out masked, FDR-adjusted p-values for visualization.
write.table(meta_analysis_model_c_unsmoothed_left_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_unsmoothed_maineffect_DX_left_p_adjust_masked.txt", sep = "", row.names = FALSE, col.names = FALSE)
write.table(meta_analysis_model_c_unsmoothed_right_p_adjust_masked,"/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_unsmoothed_maineffect_DX_right_p_adjust_masked.txt", sep = "", row.names= FALSE, col.names =FALSE)


###Write out vertstats files for visualization
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_left_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_left_unsmoothed_maineffect_DX.vertstats", headers=TRUE)
mni.write.vertex.stats(meta_analysis_model_c_unsmoothed_right_1, "/data/chamal/projects/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/model_c_right_unsmoothed_maineffect_DX.vertstats", headers=TRUE)
