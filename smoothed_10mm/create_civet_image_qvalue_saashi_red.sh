...
colour_object $leftbrain $leftstatmap $TMPDIR/left_comb.obj user /data/chamal/resources/Display-colormaps/RMINC_red.lut $leftFDR5 $leftFDR1 white "1 1 0" replace
...
colour_object $rightbrain $rightstatmap $TMPDIR/right_comb.obj user /data/chamal/resources/Display-colormaps/RMINC_red.lut $rightFDR5 $rightFDR1 white "1 1 0" replace
