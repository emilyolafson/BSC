...
#Colourize left
#colour_object $leftbrain $leftstatmap $TMPDIR/left_comb.obj user /data/chamal/resources/Display-colormaps/colourmaps/frommatplotlib/virdis.lut $leftFDR1 $leftFDR5 "0.993248 0.906157 0.143936" white replace
colour_object $leftbrain $leftstatmap $TMPDIR/left_comb.obj user /data/chamal/resources/Display-colormaps/colourmaps/frommatplotlib/virdis.lut $leftFDR5 $leftFDR1 "0.267004 0.004874 0.329415" "0.993248 0.906157 0.143936" replace


#Colourize right
#colour_object $rightbrain $rightstatmap $TMPDIR/right_comb.obj user /data/chamal/resources/Display-colormaps/colourmaps/frommatplotlib/virdis.lut $rightFDR1 $rightFDR5 "0.993248 0.906157 0.143936" white replace
colour_object $rightbrain $rightstatmap $TMPDIR/right_comb.obj user /data/chamal/resources/Display-colormaps/colourmaps/frommatplotlib/virdis.lut $rightFDR5 $rightFDR1 "0.267004 0.004874 0.329415" "0.993248 0.906157 0.143936" replace
