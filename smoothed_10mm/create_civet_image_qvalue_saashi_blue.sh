...
#Colourize left
colour_object $leftbrain $leftstatmap $TMPDIR/left_comb.obj user /home/cic/olaemi/emilyO/Tissue_contrast/analysis/main_effect/smoothed_10mm/hotred.map $leftFDR1 $leftFDR5 "0 1 1" white replace
