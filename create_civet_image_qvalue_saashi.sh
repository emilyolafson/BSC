...
#Colourize left
colour_object $leftbrain $leftstatmap $TMPDIR/left_comb.obj hot $leftFDR1 $leftFDR5 red white replace


#Colourize right
colour_object $rightbrain $rightstatmap $TMPDIR/right_comb.obj hot $rightFDR1 $rightFDR5 red white replace
